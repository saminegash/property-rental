      ...
      <header className="dashboard-header" style={{ borderBottomColor: "var(--color-primary)" }}>
        <div className="dashboard-header-inner">
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            <Link href={`/${lang}`} className="dashboard-logo">
              MyEthioProperties
            </Link>
            ...
            <nav style={{ display: "flex", gap: "1rem", marginLeft: "2rem" }}>
              <Link href={`/${lang}/admin`} className="text-sm font-medium text-slate-600 hover:text-slate-900">Overview</Link>
              <Link href={`/${lang}/admin/listings`} className="text-sm font-medium text-slate-600 hover:text-slate-900">Listings</Link>
              <Link href={`/${lang}/admin/requests`} className="text-sm font-medium text-slate-600 hover:text-slate-900">Requests</Link>
              <Link href={`/${lang}/admin/owners`} className="text-sm font-medium text-slate-600 hover:text-slate-900">Owners</Link>
            </nav>
          </div>
