  ...
  return (
    <div className="bg-slate-50 min-h-screen py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        {/* Images Grid */}
        <div className="mb-10 grid grid-cols-1 gap-4 md:grid-cols-4 md:grid-rows-2 h-[400px] md:h-[500px]">
          {/* Main Image */}
          <div className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded-2xl bg-slate-200 h-full">
